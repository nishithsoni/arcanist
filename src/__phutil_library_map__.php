...
phutil_register_library_map(array(
  ...
  'class' => array(
    ...
    'ArcanistBuildableNotPassingException' => 'exception/usage/ArcanistBuildableNotPassingException.php',
    ...
    'ArcanistDiffBasedWorkflow' => 'workflow/ArcanistDiffBasedWorkflow.php',
    ...
    'ArcanistNoopLinter' => 'lint/linter/ArcanistNoopLinter.php',
    ...
    'ArcanistPatchWorkflowTestCase' => 'workflow/__tests__/ArcanistPatchWorkflowTestCase.php',
    ...
    'ArcanistPhpunit6TestResultParser' => 'unit/parser/ArcanistPhpunit6TestResultParser.php',
    ...
    'ArcanistStackWorkflow' => 'workflow/ArcanistStackWorkflow.php',
    ...
    'ArcanistSubmitWorkflow' => 'workflow/ArcanistSubmitWorkflow.php',
    ...
    'ArcanistUberPuppetLinter' => 'lint/linter/UberPuppetLinter.php',
    ...
    'CompareCommitToRevisionWorkflow' => 'workflow/CompareCommitToRevisionWorkflow.php',
    'CompareCommitToRevisionWorkflowTestCase' => 'workflow/__tests__/CompareCommitToRevisionWorkflowTestCase.php',
    ...
    'ICArcanistBundler' => 'flow/repository/ICArcanistBundler.php',
    'ICArcanistWorkflow' => 'flow/workflow/ICArcanistWorkflow.php',
    'ICBoxDrawing' => 'flow/console/ICBoxDrawing.php',
    'ICCacheFactory' => 'flow/util/ICCacheFactory.php',
    'ICCascadeWorkflow' => 'flow/workflow/ICCascadeWorkflow.php',
    'ICConsoleTree' => 'flow/console/ICConsoleTree.php',
    'ICDataCacheWrapper' => 'flow/util/ICDataCacheWrapper.php',
    'ICFlowBaseWorkflow' => 'flow/workflow/ICFlowBaseWorkflow.php',
    'ICFlowChangedLinesField' => 'flow/field/ICFlowChangedLinesField.php',
    'ICFlowConfiguration' => 'flow/configuration/ICFlowConfiguration.php',
    'ICFlowConfigurationManager' => 'flow/ICFlowConfigurationManager.php',
    'ICFlowCurrentField' => 'flow/field/ICFlowCurrentField.php',
    'ICFlowDescriptionField' => 'flow/field/ICFlowDescriptionField.php',
    'ICFlowFeature' => 'flow/model/ICFlowFeature.php',
    'ICFlowField' => 'flow/field/ICFlowField.php',
    'ICFlowHashField' => 'flow/field/ICFlowHashField.php',
    'ICFlowMonogramField' => 'flow/field/ICFlowMonogramField.php',
    'ICFlowOpenCommentsField' => 'flow/field/ICFlowOpenCommentsField.php',
    'ICFlowOwnerField' => 'flow/field/ICFlowOwnerField.php',
    'ICFlowRef' => 'flow/model/ICFlowRef.php',
    'ICFlowRefMissingFieldException' => 'flow/model/ICFlowRefMissingFieldException.php',
    'ICFlowStatusField' => 'flow/field/ICFlowStatusField.php',
    'ICFlowSummary' => 'flow/ICFlowSummary.php',
    'ICFlowWorkflow' => 'flow/workflow/ICFlowWorkflow.php',
    'ICFlowWorkspace' => 'flow/ICFlowWorkspace.php',
    'ICGitAPI' => 'flow/repository/ICGitAPI.php',
    'ICGitBranchGraph' => 'flow/repository/ICGitBranchGraph.php',
    'ICGlyphLibrary' => 'flow/console/ICGlyphLibrary.php',
    'ICGraftWorkflow' => 'flow/workflow/ICGraftWorkflow.php',
    'ICSyncWorkflow' => 'flow/workflow/ICSyncWorkflow.php',
    'ICTidyWorkflow' => 'flow/workflow/ICTidyWorkflow.php',
    'LintTrapLinter' => 'lint/linter/LintTrapLinter.php',
    'MavenTestEngine' => 'unit/engine/UberMavenTestEngine.php',
    'MockConduit' => 'land/__tests__/UberArcanistSubmitQueueEngineTestCase.php',
    'MockSubmitQueueClient' => 'land/__tests__/UberArcanistSubmitQueueEngineTestCase.php',
    'NoseTestEngine' => 'unit/engine/NoseTestEngine.php',
    'Phpunit6TestEngine' => 'unit/engine/Phpunit6TestEngine.php',
    ...
    'UberArcPostPushListener' => 'listener/UberArcPostPushListener.php',
    'UberArcPrePushEventListener' => 'listener/UberArcPrePushEventListener.php',
    'UberArcanistStackGitLandEngine' => 'land/UberArcanistStackGitLandEngine.php',
    'UberArcanistStackSubmitQueueEngine' => 'land/UberArcanistStackSubmitQueueEngine.php',
    'UberArcanistSubmitQueueEngine' => 'land/UberArcanistSubmitQueueEngine.php',
    'UberArcanistSubmitQueueEngineTestCase' => 'land/__tests__/UberArcanistSubmitQueueEngineTestCase.php',
    'UberCheckstyleLinter' => 'lint/linter/UberCheckstyleLinter.php',
    'UberConfigurableTestEngine' => 'unit/engine/UberConfigurableTestEngine.php',
    'UberCustomCommandTestEngine' => 'unit/engine/UberCustomCommandTestEngine.php',
    ...
    'UberGitHubBetaUsers' => 'uber/UberGitHubBetaUsers.php',
    ...
    'UberMandatoryFields' => 'uber/UberMandatoryFields.php',
    'UberMultiTestEngine' => 'unit/engine/UberMultiTestEngine.php',
    ...
    'UberSingleScriptAndRegexLinter' => 'lint/linter/UberSingleScriptAndRegexLinter.php',
    'UberStandardLinter' => 'lint/linter/UberStandardLinter.php',
    'UberStaticAnalysisLinter' => 'lint/linter/UberStaticAnalysisLinter.php',
    'UberSubmitQueueClient' => 'land/UberSubmitQueueClient.php',
    'UberSubmitQueueFuture' => 'land/UberSubmitQueueFuture.php',
    'UberTask' => 'uber/UberTask.php',
    'UberTestPlanIOSAndroidTestEngine' => 'unit/engine/UberTestPlanIOSAndroidTestEngine.php',
    'UberTestPlanTestEngine' => 'unit/engine/UberTestPlanTestEngine.php',
    'UberUSSO' => 'uber/UberUSSO.php',
  ...
  'function' => array(
    'ic_blob_cache' => 'flow/util/cache.php',
    'ic_blob_cache_dir' => 'flow/util/cache.php',
    'ic_cache' => 'flow/util/cache.php',
    'ic_constant_tmpdir' => 'flow/util/util.php',
    'ic_data_cache' => 'flow/util/cache.php',
    'ic_data_cache_dir' => 'flow/util/cache.php',
    'ic_get_preferred_repo_uri' => 'flow/util/util.php',
    'ic_get_repository_root' => 'flow/util/util.php',
    'ic_join_paths' => 'flow/util/util.php',
    'ic_list_blob_caches' => 'flow/util/cache.php',
    'ic_list_caches' => 'flow/util/cache.php',
    'ic_list_data_caches' => 'flow/util/cache.php',
    'ic_resolve_subpath' => 'flow/util/util.php',
    'ic_standard_cache' => 'flow/util/cache.php',
  ),
  'xmap' => array(
    ...
    'ArcanistBuildableNotPassingException' => 'ArcanistUsageException',
    ...
    'ArcanistDiffBasedWorkflow' => 'ArcanistWorkflow',
    ...
    'ArcanistDiffWorkflow' => 'ArcanistDiffBasedWorkflow',
    ...
    'ArcanistGoVetLinter' => 'ArcanistNoopLinter',
    ...
    'ArcanistNoopLinter' => 'ArcanistExternalLinter',
    ...
    'ArcanistPatchWorkflow' => 'ArcanistDiffBasedWorkflow',
    'ArcanistPatchWorkflowTestCase' => 'PhutilTestCase',
    ...
    'ArcanistStackWorkflow' => 'ArcanistWorkflow',
    ...
    'ArcanistSubmitWorkflow' => 'ArcanistWorkflow',
    ...
    'ArcanistUberPuppetLinter' => 'ArcanistExternalLinter',
    ...
    'CompareCommitToRevisionWorkflow' => 'ArcanistWorkflow',
    'CompareCommitToRevisionWorkflowTestCase' => 'PhutilTestCase',
    'ConfigurableGolangTestEngine' => 'UberConfigurableTestEngine',
    'ConfigurablePytestTestEngine' => 'UberConfigurableTestEngine',
    'ESLintLinter' => 'ArcanistExternalLinter',
    'ICArcanistBundler' => 'Phobject',
    'ICArcanistWorkflow' => 'ArcanistWorkflow',
    'ICBoxDrawing' => 'Phobject',
    'ICCacheFactory' => 'Phobject',
    'ICCascadeWorkflow' => 'ICFlowBaseWorkflow',
    'ICConsoleTree' => 'PhutilConsoleView',
    'ICDataCacheWrapper' => 'PhutilKeyValueCacheProxy',
    'ICFlowBaseWorkflow' => 'ICArcanistWorkflow',
    'ICFlowChangedLinesField' => 'ICFlowField',
    'ICFlowConfiguration' => 'ArcanistConfiguration',
    'ICFlowConfigurationManager' => 'Phobject',
    'ICFlowCurrentField' => 'ICFlowField',
    'ICFlowDescriptionField' => 'ICFlowField',
    'ICFlowFeature' => 'Phobject',
    'ICFlowField' => 'Phobject',
    'ICFlowHashField' => 'ICFlowField',
    'ICFlowMonogramField' => 'ICFlowField',
    'ICFlowOpenCommentsField' => 'ICFlowField',
    'ICFlowOwnerField' => 'ICFlowField',
    'ICFlowRef' => 'Phobject',
    'ICFlowRefMissingFieldException' => 'Exception',
    'ICFlowStatusField' => 'ICFlowField',
    'ICFlowSummary' => 'PhutilConsoleView',
    'ICFlowWorkflow' => 'ICFlowBaseWorkflow',
    'ICFlowWorkspace' => 'Phobject',
    'ICGitAPI' => 'Phobject',
    'ICGitBranchGraph' => 'AbstractDirectedGraph',
    'ICGlyphLibrary' => 'Phobject',
    'ICGraftWorkflow' => 'ICFlowBaseWorkflow',
    'ICSyncWorkflow' => 'ICArcanistWorkflow',
    'ICTidyWorkflow' => 'ICFlowBaseWorkflow',
    'LintTrapLinter' => 'ArcanistExternalLinter',
    'MavenTestEngine' => 'ArcanistUnitTestEngine',
    ...
    'UberArcanistSubmitQueueEngineTestCase' => 'PhutilTestCase',
    'UberCheckstyleLinter' => 'ArcanistFutureLinter',
    'UberConfigurableTestEngine' => 'ArcanistUnitTestEngine',
    'UberCustomCommandTestEngine' => 'ArcanistUnitTestEngine',
    'UberFZF' => 'Phobject',
    'UberFilesizeTestEngine' => 'ArcanistUnitTestEngine',
    'UberFilesizeTestEngineTestCase' => 'PhutilTestCase',
    'UberGitHubBetaUsers' => 'Phobject',
    'UberGitSecretsLinter' => 'ArcanistExternalLinter',
    'UberGradleTestEngine' => 'ArcanistUnitTestEngine',
    'UberJiraIssueMessageParser' => 'Phobject',
    'UberMandatoryFields' => 'Phobject',
    'UberMultiTestEngine' => 'ArcanistUnitTestEngine',
    'UberObjCStyleCheckLinter' => 'ArcanistExternalLinter',
    'UberPupetLintLinter' => 'ArcanistExternalLinter',
    'UberPythonImportsLinter' => 'ArcanistLinter',
    'UberRevertPlanTestEngine' => 'ArcanistUnitTestEngine',
    'UberShellCheckLinter' => 'ArcanistExternalLinter',
    'UberShellCheckLinterTestCase' => 'ArcanistExternalLinterTestCase',
    'UberSingleScriptAndRegexLinter' => 'ArcanistLinter',
    'UberStandardLinter' => 'ArcanistExternalLinter',
    'UberStaticAnalysisLinter' => 'ArcanistFutureLinter',
    'UberSubmitQueueClient' => 'Phobject',
    'UberSubmitQueueFuture' => 'FutureProxy',
    'UberTask' => 'Phobject',
    'UberTestPlanIOSAndroidTestEngine' => 'ArcanistUnitTestEngine',
    'UberTestPlanTestEngine' => 'ArcanistUnitTestEngine',
    'UberUSSO' => 'Phobject',
